...
var Portal = function (_React$Component) {
  ...
  _createClass(Portal, [{
    ...
    value: function handleOutsideMouseClick(e) {
      ...
      if (root.contains(e.target) || e.button && e.button !== 0 || !this.props.isElementOutside(e.target)) {
        return;
      }
...
Portal.propTypes = {
  ...
  isElementOutside: _propTypes2.default.func,
...
Portal.defaultProps = {
  ...
  isElementOutside: function isElementOutside() {
    return true;
  }
};
